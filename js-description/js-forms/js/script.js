...
//========================================================================================================================================================
// ? Делаю ДЗ
// Получаем колекцию форм на странице
...
// ecли имя с дефисом
/* const myForm1 = document.forms['my-Form'];
console.log(myForm1); */

const myForm2 = document.forms.myForm;
// console.log(myForm2);
...
console.log(myForm2.elements.inputCheck);
...
console.log(inputRadio[1].value);
