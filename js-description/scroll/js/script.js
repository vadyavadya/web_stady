...
*/
/*
const elementTitle = document.querySelector('.lesson__title');
const elementText = document.querySelector('.lesson__text');
const elementItem = document.querySelector('.lesson__item');

console.log(elementTitle, elementText, elementItem);
console.log(elementTitle.getBoundingClientRect().top);
console.log(elementText.getBoundingClientRect().top);

getXYElement(elementTitle);
getXYElement(elementText);
getXYElement(elementItem);


function getXYElement(element) {
	let elementLeftWindow = element.getBoundingClientRect().left;
	let elementLeftDocument = element.getBoundingClientRect().left + window.pageXOffset;

	let elementTopWindow = element.getBoundingClientRect().top;
	let elementTopDocument = element.getBoundingClientRect().top + window.pageYOffset;
	console.log(`Элемент ${element.classList}`);
	console.log(`Координаты относитьльно окна ${elementLeftWindow}, ${elementTopWindow}`);
	console.log(`Координаты относитьльно документа ${elementLeftDocument}, ${elementTopDocument}`);
}
 */
