...
/* //*  Получения элементов формы document.forms.elements
...
const mainForm = document.forms.main;
const mainFormSelect = mainForm.nameSelectMult;
...
*/
/* // Пример
const lesson = document.querySelector('.lesson-form');
...
lesson.addEventListener("blur", function (e) {
    ...
    console.log('Див lesson не в фокусе!');
});
 */

/* //* Текущий элемент с фокусом можно получитьиз document.activeElement.
...
// поймать на этапе погружения, { "capture": true }
 */
