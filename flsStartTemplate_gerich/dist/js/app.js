        ...
        function parallaxBg(imgPath = void 0) {
            window.addEventListener("load", (function() {
                ...
                if (elementsParallaxBg.length) elementsParallaxBg.forEach((elementParallaxBg => {
                    ...
                    if (elementParallaxBg.offsetHeight > 0) elementParallaxBg.insertAdjacentHTML("afterbegin", `<div class="bg-paralax__box" style="height:${elementParallaxBg.offsetHeight}px"><div class="bg-paralax__image" style="background-image:${imgPath}; height:${bgHeight}px;"></div></div>`);
