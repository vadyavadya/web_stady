        ...
        function parallaxBg(imgPath = void 0) {
            window.addEventListener("load", (function() {
                ...
                if (elementsParallaxBg.length) elementsParallaxBg.forEach((elementParallaxBg => {
                    ...
                    if (elementParallaxBg.offsetHeight > 0) elementParallaxBg.insertAdjacentHTML("afterbegin", `<div class="bg-paralax" style="background-image:${imgPath}; height:${bgHeight}px;"></div>`);
                    console.log(imgPath);
